...
img = cv2.imread('capture_hb/cam10.jpg')
(x1, y1) = img.shape[:2]
target = img[:,:,[1,2,0]]
...
llo_h = mlo_h*decrease
llo_s = mlo_s*decrease
llo_v  = mlo_v*decrease

lhi_h = mlo_h*increase
lhi_s = mlo_s*increase
lhi_v  = mlo_v*increase
